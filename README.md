...
* FCN_V1 (2014)에서 직접적인 영향을 받은 모델들:
  ...
  * global context 반영 위해 global pooling 사용: ParseNet (2015) 
  * 모든 레이어에서 skip 사용: U-Net (2015) ([note](./paper/U-Net%20-%20Convolutional%20Networks%20for%20Biomedical%20Image%20Segmentation.pdf))
