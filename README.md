...
## Multimodal Learning
* DeVise - A Deep Visual-Semantic Embedding Model: ([note](./paper/DeViSE\ -\ A\ Deep\ Visual-Semantic\ Embedding\ Model.pdf))
...
* Multimodal Machine Learning: A Survey and Taxonomy: ([note](./paper/Multimodal\ Machine\ Learning\ -\ A\ Survey\ and\ Taxonomy.pdf))
